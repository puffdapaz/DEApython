...
# API URL
link_pop_estim = 'https://servicodados.ibge.gov.br/api/v3/agregados/6579/periodos/2017|2019|2021/variaveis/9324?localidades=N6[N3[11,12,13,14,15,16,17,21,22,23,24,25,26,27,28,29,31,32,33,35,41,42,43,50,51,52,53]]'
...
df_pop_estim['2021'] = df_pop_estim['2021'].str.replace(',', '.').astype(float)
